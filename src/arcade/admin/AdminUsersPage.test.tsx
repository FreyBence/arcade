...
describe('AdminUsersPage', () => {
  it.each(cases)('$name', async ({ input, expected }) => {
    ...
    render(<ToastProvider><AdminUsersPage client={{ search, updateDinoCoins }} /></ToastProvider>)
...
describe('AdminUsersPage Dino Coin management', () => {
  it.each(balanceCases)('$name', async ({ input, expected }) => {
    ...
    const user = userEvent.setup()
    render(<ToastProvider><AdminUsersPage client={{ search: () => Promise.resolve([dino]), updateDinoCoins }} /></ToastProvider>)
