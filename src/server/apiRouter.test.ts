...
function createApi(): ApplicationApi {
  ...
  return { register: handler, login: handler, refresh: handler, logout: handler, identity: handler, updateProfile: handler, changePassword: handler, googleAuthorization: handler, googleCallback: handler, adminUsers: handler, updateAdminDinoCoins: handler }
}
